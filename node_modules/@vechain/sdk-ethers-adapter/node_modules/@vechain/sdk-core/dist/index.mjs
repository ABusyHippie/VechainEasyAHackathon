...
import { ADDRESS as ADDRESS2, assert as assert21 } from "@vechain/sdk-errors";
...
import { assert as assert8, RLP_ERRORS as RLP_ERRORS2 } from "@vechain/sdk-errors";
...
import { assert as assert5, SECP256K1 } from "@vechain/sdk-errors";
...
import { assert as assert6, DATA as DATA4, SECP256K1 as SECP256K12, TRANSACTION } from "@vechain/sdk-errors";
...
import { assert as assert7, RLP_ERRORS } from "@vechain/sdk-errors";
...
import { assert as assert9, RLP_ERRORS as RLP_ERRORS3 } from "@vechain/sdk-errors";
var validateNumericKindData = (data, context) => {
  assert9(
    "validateNumericKindData",
    typeof data === "number" || typeof data === "string",
    RLP_ERRORS3.INVALID_RLP,
...
import { assert as assert10, RLP_ERRORS as RLP_ERRORS4 } from "@vechain/sdk-errors";
var assertValidHexBlobKindData = (data, context) => {
  assert10(
    "assertValidHexBlobKindData",
    typeof data === "string",
    RLP_ERRORS4.INVALID_RLP,
...
import { assert as assert11, RLP_ERRORS as RLP_ERRORS5 } from "@vechain/sdk-errors";
var assertFixedHexBlobKindData = (data, context, bytes3) => {
  assert11(
    "assertFixedHexBlobKindData",
    data.length === bytes3 * 2 + 2,
    RLP_ERRORS5.INVALID_RLP,
...
import { assert as assert12, RLP_ERRORS as RLP_ERRORS6 } from "@vechain/sdk-errors";
var assertCompactFixedHexBlobBuffer = (buffer, context, bytes3) => {
  assert12(
    "assertCompactFixedHexBlobBuffer",
    buffer.length <= bytes3,
    RLP_ERRORS6.INVALID_RLP,
...
import { ADDRESS, assert as assert16, BLOOM as BLOOM2, DATA as DATA7 } from "@vechain/sdk-errors";

// src/utils/hex/hex.ts
import { assert as assert13, buildError as buildError4, DATA as DATA5 } from "@vechain/sdk-errors";
...
// src/bloom/bloom.ts
import { assert as assert15, BLOOM } from "@vechain/sdk-errors";
...
import { buildError as buildError5, DATA as DATA6 } from "@vechain/sdk-errors";
...
import { assert as assert17, buildError as buildError6, DATA as DATA8 } from "@vechain/sdk-errors";
...
import { assert as assert19, buildError as buildError7, DATA as DATA10 } from "@vechain/sdk-errors";
...
import { assert as assert20, SECP256K1 as SECP256K13 } from "@vechain/sdk-errors";
...
import { assert as assert22, CERTIFICATE } from "@vechain/sdk-errors";
...
import { assert as assert23, buildError as buildError8, DATA as DATA11 } from "@vechain/sdk-errors";
...
import { buildError as buildError9, HDNODE } from "@vechain/sdk-errors";
...
import {
  assert as assert24,
  buildError as buildError10,
  KEYSTORE,
  stringifyData as stringifyData3
} from "@vechain/sdk-errors";
...
function isValid(keystore4) {
  return ethers3.isKeystoreJson(stringifyData3(keystore4));
}
var keystore = { encrypt, decrypt, isValid };

// src/keystore/cryptography/experimental/keystore.ts
import { assert as assert25, KEYSTORE as KEYSTORE2, stringifyData as stringifyData4 } from "@vechain/sdk-errors";
...
function isValid2(keystore4) {
  try {
    const copy = JSON.parse(stringifyData4(keystore4));
...
import { assert as assert26, buildError as buildError11, HDNODE as HDNODE2 } from "@vechain/sdk-errors";
...
function deriveAddress(words, path = "m/0") {
  ...
  try {
    ...
    throw buildError11(
      "HDNode.fromMnemonic",
      HDNODE2.INVALID_HDNODE_DERIVATION_PATH,
...
import { ADDRESS as ADDRESS3, assert as assert27, SECP256K1 as SECP256K14, TRANSACTION as TRANSACTION2 } from "@vechain/sdk-errors";
...
import { assert as assert28, TRANSACTION as TRANSACTION3 } from "@vechain/sdk-errors";
...
import { assert as assert29, TRANSACTION as TRANSACTION4 } from "@vechain/sdk-errors";
